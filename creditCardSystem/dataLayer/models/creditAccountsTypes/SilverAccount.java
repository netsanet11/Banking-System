...
public class SilverAccount extends CreditAccountBase
{
    public SilverAccount(int accountId, double monthlyInterest, double minimumPayment)
    {
        super(accountId, monthlyInterest, minimumPayment);
    }

    public SilverAccount(int accountId, LocalDateTime createdDate, LocalDateTime lastModified, double balance, List<TransactionHistory> transactionsHistory, double monthlyInterest, double minimumPayment)
    {
